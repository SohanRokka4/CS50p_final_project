...
import json
import os
from project import get_fernet, retrive_password, add_new_password, delete_password, change_password, generate_random_password
...
def test_retrieve_password(mock_exists, mock_file, mock_input):
    with patch('builtins.print') as mock_print:
        retrive_password("testsite", "testuser")
...
def test_delete_password(mock_exists, mock_file, mock_input):
    ...
    delete_password("testsite", "testuser")
    mock_file().write.assert_called_once_with(json.dumps(expected_passwords))
